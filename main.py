...
class MainApp:
    def __init__(self):
        self.root = tk.Tk()
        self.root.title("ScreenTranslate")
    ...
    def _build_ui(self):
        ...
        tk.Label(sb, text="SCREEN\nTRANSLATE", bg=Config.UI_BG_SIDEBAR, fg=Config.UI_ACCENT, font=("Segoe UI", 14, "bold"), justify=tk.LEFT, pady=20).pack(fill=tk.X)
        ...
        self.bubble_mode = tk.StringVar(value=Config.BUBBLE_MODE)     
    ...
    def run(self):
        logging.info("Запуск ScreenTranslate...")
        self.root.mainloop()
